import numpy as np
from ballbot_common.controllers.control_utils.network import Config
import operator
...
class CADRL_Agent():
    ...
    def _check_if_at_goal(self):
        ...
        # print "CADRL_Agent:",self.id,"is_near_goal:",is_near_goal,"was_at_goal_already:", self.was_at_goal_already,"is_at_goal:",self.is_at_goal
    ...
    def update_state(self, action, dt):
        ...
        if self.action_time_lag > 0:
            ...
            # print "-------------"
            # print "CADRL_Agent id: %i" %self.id
            ...
            if timestamp_of_action_to_execute < 0:
                ...
                nearest_timestamp, _ = CADRL_Agent.find_nearest(np.array(self.chosen_action_dict.keys()), timestamp_of_action_to_execute)
        ...
        selected_heading = CADRL_Agent.wrap(action_to_execute[1] + self.heading_global_frame) # in global frame
        ...
        self.heading_ego_frame = CADRL_Agent.wrap(self.heading_global_frame - ref_prll_angle_global_frame)
    ...
    def observe(self, agents):
        ...
        for i, other_agent in enumerate(agents):
            ...
            if dist_between_agent_centers > Config.SENSING_HORIZON:
                # print "CADRL_Agent too far away"
                continue
